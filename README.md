...
這是非 Streamlit 股票預測網站。後端使用 Python 標準 HTTP server 提供 API，前端使用原生 HTML/CSS/JavaScript，包含搜尋、K 線圖、新聞情緒、關聯美股/產業指標、TWSE 三大法人籌碼、十因子矩陣、模型回測，以及台股下次開盤攻擊候選推薦。
...
- 十因子矩陣會納入：大盤方向、產業同業、重大消息、財報預期差、估值、技術、量能流動性、籌碼、選擇權/衍生品、宏觀事件
